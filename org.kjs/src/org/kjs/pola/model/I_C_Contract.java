...
public interface I_C_Contract 
{
    ...
    /** Column name C_Contract_UU */
    public static final String COLUMNNAME_C_Contract_UU = "C_Contract_UU";

	/** Set Contract Document	  */
	public void setC_Contract_UU (String C_Contract_UU);

	/** Get Contract Document	  */
	public String getC_Contract_UU();
