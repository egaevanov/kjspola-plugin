...
public class WCreateFromProductionUI extends CreateFromProduction implements EventListener<Event>, ValueChangeListener
{
    private WCreateFromWindow window;
    private int p_WindowNo;
    private boolean m_actionActive;
    
    public WCreateFromProductionUI(final GridTab gridTab) {
        super(gridTab);
    ...
    public void valueChange(final ValueChangeEvent e) {
        ...
        if (e.getPropertyName().equals("KJS_ProductionPlanLine_ID") && e.getNewValue() != null) {
            e.getNewValue();
        }
    ...
    protected void loadData() {
        this.loadTableOIS(this.getBOMData(this.KJS_ProductionPlanLine_ID));
    }
