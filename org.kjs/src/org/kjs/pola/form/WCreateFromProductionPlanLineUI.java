...
public class WCreateFromProductionPlanLineUI extends CreateFromProductionPlanLine implements EventListener<Event>, ValueChangeListener
{
    private WCreateFromWindow window;
    private int p_WindowNo;
    private boolean m_actionActive;
    
    public WCreateFromProductionPlanLineUI(final GridTab gridTab) {
        super(gridTab);
    ...
    protected void loadData() {
        this.loadTableOIS(this.getBOMData(this.M_Product_ID));
    }
