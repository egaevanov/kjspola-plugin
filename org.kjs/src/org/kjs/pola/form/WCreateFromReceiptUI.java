...
public class WCreateFromReceiptUI extends CreateFromReceipt implements EventListener<Event>, ValueChangeListener
{
    ...
    protected Label asiLabel;
    protected WStringEditor asiField;
    protected Label packingLabel;
    protected WStringEditor packingField;
    private boolean m_actionActive;
    
    public WCreateFromReceiptUI(final GridTab tab) {
        super(tab);
        ...
        this.asiLabel = new Label();
        this.asiField = new WStringEditor();
        this.packingLabel = new Label();
        this.packingField = new WStringEditor();
    ...
    public boolean dynInit() throws Exception {
        ...
        this.asiField.getComponent().addEventListener("onChange", (EventListener)this);
        this.packingField.getComponent().addEventListener("onChange", (EventListener)this);
        return true;
    }
